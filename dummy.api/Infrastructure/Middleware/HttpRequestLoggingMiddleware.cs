...
{
    /// <summary>
    /// Middleware for logging HTTP requests with basic filtering of noisy ones (e.g. /monitoring/* or /swagger/*).
    /// </summary>
    public class HttpRequestLoggingMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                if (!httpContext.Request.Path.StartsWithSegments("/monitoring") && !httpContext.Request.Path.StartsWithSegments("/metrics"))
                {
                    log.Write(
                        level,
                        MessageTemplate,
